...
export default async function AdminAthleteHistoriquePage({
  params,
}: {
  params: { id: string };
}) {
      ...
      <main className="app-bg min-h-screen px-4 py-8">
        <div className="mx-auto max-w-2xl">
          <a
            ...
            className="mb-4 inline-block text-sm text-pink-300"
          >
            ← Retour au profil
          </a>
          <h1 className="mb-6 text-2xl font-bold text-white">
            Historique — {athlete.full_name ?? athlete.username}
          </h1>
